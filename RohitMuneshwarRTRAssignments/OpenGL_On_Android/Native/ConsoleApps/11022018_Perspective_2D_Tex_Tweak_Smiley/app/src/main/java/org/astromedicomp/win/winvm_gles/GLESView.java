...
import org.astromedicomp.win.persp_2d_tex_tweak_smiely.R;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		*/
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, 2 * 4 * 4, null, GLES32.GL_DYNAMIC_DRAW);
	...
	public void display()
	{
		...
		//
	float squareTexcoords1[] = new float[8];
      
	
	if(gTapCount==1){
		squareTexcoords1[0]=0.5f;
		squareTexcoords1[1]=0.5f;
		squareTexcoords1[2]=0.0f;
		squareTexcoords1[3]=0.5f;
		squareTexcoords1[4]=0.0f;
		squareTexcoords1[5]=0.0f;
		squareTexcoords1[6]=0.5f;
		squareTexcoords1[7]=0.0f;
	} else if(gTapCount==2){
		squareTexcoords1[0]=1.0f;
		squareTexcoords1[1]=1.0f;
		squareTexcoords1[2]=0.0f;
		squareTexcoords1[3]=1.0f;
		squareTexcoords1[4]=0.0f;
		squareTexcoords1[5]=0.0f;
		squareTexcoords1[6]=1.0f;
		squareTexcoords1[7]=0.0f;			
	} else if(gTapCount==3){
		squareTexcoords1[0]=2.0f;
		squareTexcoords1[1]=2.0f;
		squareTexcoords1[2]=0.0f;
		squareTexcoords1[3]=2.0f;
		squareTexcoords1[4]=0.0f;
		squareTexcoords1[5]=0.0f;
		squareTexcoords1[6]=2.0f;
		squareTexcoords1[7]=0.0f;
	} else if(gTapCount==4){
		squareTexcoords1[0]=0.5f;
		squareTexcoords1[1]=0.5f;
		squareTexcoords1[2]=0.5f;
		squareTexcoords1[3]=0.5f;
		squareTexcoords1[4]=0.5f;
		squareTexcoords1[5]=0.5f;
		squareTexcoords1[6]=0.5f;
		squareTexcoords1[7]=0.5f;
	}else{
		squareTexcoords1[0]=1.0f;
		squareTexcoords1[1]=1.0f;
		squareTexcoords1[2]=0.0f;
		...
		ByteBuffer triColByteBuffer = ByteBuffer.allocateDirect(squareTexcoords1.length * 4);
		triColByteBuffer.order(ByteOrder.nativeOrder());
		FloatBuffer triColVerticesBuffer = triColByteBuffer.asFloatBuffer();
		triColVerticesBuffer.put(squareTexcoords1);
		triColVerticesBuffer.position(0);
		
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, 2 * 4 * 4, triColVerticesBuffer, GLES32.GL_DYNAMIC_DRAW);
		GLES32.glVertexAttribPointer(GLESMacros.SAM_ATTRIBUTE_TEXTURE0,
                                     2,
                                     GLES32.GL_FLOAT,
                                     false,0,0);
