...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private int[] gVbo_tri = new int[1];
	
	private int[] gVao_square = new int[1];
	private int[] gVbo_square = new int[1];
	...
	private void initialize(GL10 gl)
	{
		...
		GLES32.glGenBuffers(1, gVbo_tri, 0);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, gVbo_tri[0]);
		...
		GLES32.glGenBuffers(1, gVbo_square, 0);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, gVbo_square[0]);
	...
	void uninitialize()
    {
        ...
        if(gVbo_tri[0] != 0)
        {
            GLES32.glDeleteBuffers(1, gVbo_tri, 0);
            gVbo_tri[0]=0;
        }
        ...
        if(gVbo_square[0] != 0)
        {
            GLES32.glDeleteBuffers(1, gVbo_square, 0);
            gVbo_square[0]=0;
        }
