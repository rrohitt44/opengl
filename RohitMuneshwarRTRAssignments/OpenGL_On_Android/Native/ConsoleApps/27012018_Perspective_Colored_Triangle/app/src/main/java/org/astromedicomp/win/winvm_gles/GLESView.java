...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private int[] gVbo_color = new int[1];
	...
	private void initialize(GL10 gl)
	{
		...
		//color vbo
		GLES32.glGenBuffers(1,gVbo_color,0);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, gVbo_color[0]);
		
		ByteBuffer cByteBuffer = ByteBuffer.allocateDirect(triangleColor.length * 4);
		...
		GLES32.glVertexAttribPointer(GLESMacros.SAM_ATTRIBUTE_COLOR, 3, GLES32.GL_FLOAT, false, 0, 0);
	...
	void uninitialize()
    {
        ...
        if(gVbo_color[0] != 0)
        {
            GLES32.glDeleteBuffers(1, gVbo_color, 0);
            gVbo_color[0]=0;
        }
