...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow){
	...
	hwnd = CreateWindowEx(
		WS_EX_APPWINDOW,
		szAppName,
		TEXT("20 equally spaced blue lines above and below RedLine"),
...
void display(){
	...
	//20 equally spaced, full length BLUE colored horizontal lines, each of width 1, above and similarly, 20 below the horizontal RED line
	glLineWidth(3.0f);
	glBegin(GL_LINES);
