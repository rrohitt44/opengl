...
void resize(int width,int height){
	void setGlOrtho(float,float,float,float,float,float);
	if(height == 0){
		height = 1;
	}
	...
	glLoadIdentity();
	//setGlOrtho(-50.0f,50.0f,-50.0f,50.0f,-50.0f,50.0f);
...
void setGlOrtho(float left,float right,float bottom,float top,float near,float far){
	//glOrtho(left,right,bottom,top,near,far);
}
