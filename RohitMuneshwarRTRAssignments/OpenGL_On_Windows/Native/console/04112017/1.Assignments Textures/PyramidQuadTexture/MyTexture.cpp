...
void initialize(void){
	...
	LoadGLTextures(&Texture_Dada,MAKEINTRESOURCE(IDBITMAP_DADA));
	LoadGLTextures(&Texture_StoneWall,MAKEINTRESOURCE(IDBITMAP_STONEWALL));
...
void display(void){
	...
	glLoadIdentity();
	glTranslatef(-1.5f,0.0f,zoomInOut);
