...
function draw()
{
	...
	{
		vertexShaderSourceCode=vertexShaderSourceCodePF;
		fragmentShaderSourceCode=fragmentShaderSourceCodePF;
	}else if(bIsFKeyPressed==false && bIsVKeyPressed==true)
	{
		vertexShaderSourceCode=vertexShaderSourceCodePV;
		fragmentShaderSourceCode=fragmentShaderSourceCodePV;
	}else
	{
		vertexShaderSourceCode=vertexShaderSourceCodePV;
		fragmentShaderSourceCode=fragmentShaderSourceCodePV;
