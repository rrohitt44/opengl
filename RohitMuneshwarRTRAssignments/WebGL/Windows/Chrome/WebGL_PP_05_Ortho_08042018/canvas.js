...
function resize()
{
	...
	{
		mat4.ortho(orthographicProjectionMatrix, -100.0, 100.0, (-100.0 * (canvas.height / canvas.width)), (100 * (canvas.height / canvas.width)), -100.0, 100.0);
	}else
	{
		mat4.ortho(orthographicProjectionMatrix, (-100 * (canvas.width / canvas.height)), (100 * (canvas.width / canvas.height)), -100.0, 100.0, -100.0, 100.0);
	}
}
